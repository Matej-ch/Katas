...
class GuildRoseTest extends TestCase
{
    /** @test */
    function updates_normal_items_before_sell_date()
    {
        $item = GuildRose::of('normal', 10, 5);
    ...
    {
        $item = GuildRose::of('Aged Brie', 10, 5);
    ...
    {
        $item = GuildRose::of('Aged Brie', 50, 5);
    ...
    {
        $item = GuildRose::of('Aged Brie', 10, 0);
    ...
    {
        $item = GuildRose::of('Aged Brie', 49, 0);
    ...
    {
        $item = GuildRose::of('Aged Brie', 50, 0);
    ...
    {
        $item = GuildRose::of('Aged Brie', 10, -10);
    ...
    {
        $item = GuildRose::of('Aged Brie', 50, -10);
    ...
    {
        $item = GuildRose::of('Sulfuras, Hand of Ragnaros', 10, 5);
    ...
    {
        $item = GuildRose::of('Sulfuras, Hand of Ragnaros', 10, -1);
    ...
    {
        $item = GuildRose::of('Conjured Mana Cake', 10, 10);
    ...
    {
        $item = GuildRose::of('Conjured Mana Cake', 0, 10);
    ...
    {
        $item = GuildRose::of('Conjured Mana Cake', 10, 0);
    ...
    {
        $item = GuildRose::of('Conjured Mana Cake', 0, 0);
